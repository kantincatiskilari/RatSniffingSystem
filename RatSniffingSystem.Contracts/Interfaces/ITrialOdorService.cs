...
namespace RatSniffingSystem.Contracts.Interfaces
{
    ...
    public interface ITrialOdorService<TEntity, TDto, TCreateDto> : IGenericService<TEntity, TDto, TCreateDto, object>
        ...
        where TDto : class
    {
        ...
        /// <summary>
        /// Belirli bir koku tipine (OdorType) sahip kokulari getirir.
        /// </summary>
