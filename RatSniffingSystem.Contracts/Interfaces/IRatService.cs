...
{
    public interface IRatService<TEntity, TDto, TCreateDto, TUpdateDto> : IGenericService<TEntity, TDto, TCreateDto, TUpdateDto>
        where TEntity : class, RatSniffingSystem.Domain.Contracts.IHasId
        ...
        where TDto : class
    {
        ...
        /// <summary>
        /// Belirli bir dogum araligina sahip sicanlari getirir
        /// </summary>
