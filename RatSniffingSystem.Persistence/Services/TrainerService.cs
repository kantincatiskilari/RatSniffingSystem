...
{
    public class TrainerService : GenericServiceBase<Trainer, TrainerDto, CreateTrainerDto, UpdateTrainerDto> ,ITrainerService<TrainerDto, CreateTrainerDto, UpdateTrainerDto>
    {
