...
{
    public class TransferTestService : GenericServiceBase<TransferTest, TransferTestDto, CreateTransferTestDto, object>, ITransferTestService<TransferTest,TransferTestDto, CreateTransferTestDto>
    {
        public TransferTestService(AppDbContext context, IMapper mapper, ILogger<TransferTestService> logger) : base(context, mapper, logger)
        {
        }
