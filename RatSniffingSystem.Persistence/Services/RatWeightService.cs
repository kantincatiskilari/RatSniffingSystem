...
{
    public class RatWeightService : GenericServiceBase<RatWeight, RatWeightDto, CreateRatWeightDto, object>, IRatWeightService<RatWeight, RatWeightDto, CreateRatWeightDto>
    {
        public RatWeightService(AppDbContext context, IMapper mapper, ILogger<RatWeightService> logger) : base(context, mapper, logger)
        {
        }
